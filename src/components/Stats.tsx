    ...
    <section className="section" id="osszefoglalo" aria-labelledby="stats-title">
      ...
      <div className={`stats${showDaysAboveWho ? " stats--with-days" : ""}`}>
        ...
        <Stat
          ...
          tone={pmTone(data.mean, data.metric)}
          tipId="mean-tip"
          tipLabel="Mi az átlag?"
          tip={
            who != null
              ? `A kiválasztott időszak összes érvényes 3 perces mérésének számtani közepe. Alatta az látszik, a mérések hány százaléka volt a WHO ${who} µg/m³ irányértéke felett.`
        ...
        <Stat
          ...
          tone={pmTone(data.p50, data.metric)}
          tipId="median-tip"
